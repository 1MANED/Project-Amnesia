Shader "FX/Waves/Wave Creator +" {
	...
	Properties {
		...
		_ShorelineFoamAdjustment ("Shoreline Foam Adjustment", Range(0.5,2)) = 1.2
	...
	SubShader {
		...
		Pass {
			...
			vertexOutput vert(vertexInput v)
			{
				...
				float view_distance = distance (mul(_Object2World, new_position), _WorldSpaceCameraPos); 
				...
				o.tex = v.texcoord;
					...
					o.view_direction = normalize (_WorldSpaceCameraPos.xyz - o.pos_world.xyz);
