...
public class WaveCreatorEditor : MaterialEditor {
	...
	public override void OnInspectorGUI () {
		...
		if (Foldout ("Reflection", 3)) {
			
			EditorGUILayout.Space ();
			EditorGUILayout.HelpBox ("If you change your skybox you will need to change the textures on the cubemap to get correct reflection effects.", MessageType.Warning);
